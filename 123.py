...
def runGame():
    ...
    while True: # main game loop
        ...
        # 判断蛇是否咬到了自己，超出范围时从另一端出来
          ...
          #  return # game 
        if wormCoords[HEAD]['x'] == CELLWIDTH: # 蛇撞墙不会死
                wormCoords[HEAD]['x'] = 0
        ...
        for wormBody in wormCoords[1:]:
            if wormBody['x'] == wormCoords[HEAD]['x'] and wormBody['y'] == wormCoords[HEAD]['y']:
                return # game over
        #判断是否触碰障碍物
        if wormCoords[HEAD]['x'] in range(3,11) and wormCoords[HEAD]['y'] ==5:
            return
        if wormCoords[HEAD]['x'] in range(21,18) and wormCoords[HEAD]['y'] ==5:
            return
        if wormCoords[HEAD]['x'] in range(13,16) and wormCoords[HEAD]['y'] ==17:
            return
        if wormCoords[HEAD]['x'] in [9,27] and wormCoords[HEAD]['y'] ==6:
            return
        if wormCoords[HEAD]['x'] ==16 and wormCoords[HEAD]['y'] ==16:
            return
        if wormCoords[HEAD]['x'] ==17 and wormCoords[HEAD]['y'] ==15:
            return
...
def showStartScreen():
    ...
    titleSurf1 = titleFont.render('come on!', True, WHITE, DARKGREEN)
    titleSurf2 = titleFont.render('come on!', True, GREEN)
